...
// plane website url
export const WEBSITE_URL = getEnv("VITE_WEBSITE_URL") || getEnv("NEXT_PUBLIC_WEBSITE_URL") || "https://plane.so";

// support email
export const SUPPORT_EMAIL = getEnv("VITE_SUPPORT_EMAIL") || getEnv("NEXT_PUBLIC_SUPPORT_EMAIL") || "support@plane.so";
