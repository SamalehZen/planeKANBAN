...
const createDragHandleElement = (): HTMLElement => {
  ...
  dragHandleElement.classList.value =
    "flex items-center justify-center min-w-[24px] min-h-[24px] rounded cursor-grab outline-none hover:bg-custom-background-80 active:bg-custom-background-90 active:cursor-grabbing transition-colors duration-200";
  dragHandleElement.title = "Glisser pour déplacer";

  const iconElement = document.createElement("span");
  iconElement.classList.value = "pointer-events-none text-custom-text-300 flex items-center justify-center";
  iconElement.innerHTML = dragIcon;
