...
CORS_ALLOW_HEADERS = [*default_headers, "X-API-Key", "Authorization"]
...
AWS_STORAGE_BUCKET_NAME = os.environ.get("AWS_S3_BUCKET_NAME", "plane-uploads")
...
if AWS_S3_ENDPOINT_URL and USE_MINIO and not AWS_S3_CUSTOM_DOMAIN:
