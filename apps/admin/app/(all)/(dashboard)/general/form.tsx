      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-14 px-4 py-3 border border-subtle rounded-sm">
          <div className="grow flex items-center gap-4">
            ...
            <div className="grow">
              <div className="text-13 font-medium text-primary leading-5">Let HyperPLANE collect anonymous usage data</div>
              <div className="text-11 font-regular text-tertiary leading-5">
                No PII is collected. This anonymized data is used to understand how you use HyperPLANE and build new features.
              </div>
            </div>
          </div>
