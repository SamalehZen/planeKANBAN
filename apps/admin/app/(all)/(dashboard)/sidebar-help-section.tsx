...
const helpOptions = [
  ...
  },
  {
    ...
    href: "https://github.com/SamalehZen/planeKANBAN/discussions",
    Icon: DiscordIcon,
  },
  {
    name: "Report a bug",
    href: "https://github.com/SamalehZen/planeKANBAN/issues/new/choose",
    Icon: GithubIcon,
  },
];
  ...
  return (
    ...
    >
      <div className={`flex items-center gap-1 ${isSidebarCollapsed ? "flex-col justify-center" : "w-full"}`}>
        <Tooltip tooltipContent="Redirect to HyperPLANE" position="right" className="ml-4" disabled={!isSidebarCollapsed}>
          <a
          ...
          >
            ...
            {!isSidebarCollapsed && "Redirect to HyperPLANE"}
          </a>
        </Tooltip>
