...
import { OpenSourceBadge } from "@/components/common/open-source-badge";
  ...
  return (
    <>
      ...
      <CustomMenu
        ...
        closeOnSelect
      >
        <CustomMenu.MenuItem onClick={() => window.open("https://github.com/SamalehZen/planeKANBAN", "_blank")}>
        ...
        <CustomMenu.MenuItem onClick={() => window.open("mailto:samaleh2017@gmail.com", "_blank")}>
          <div className="flex items-center gap-x-2 rounded-sm text-11">
        ...
        <CustomMenu.MenuItem
          onClick={() => window.open("https://github.com/SamalehZen/planeKANBAN/discussions", "_blank", "noopener,noreferrer")}
        >
          <div className="flex items-center gap-x-2 rounded-sm text-11">
            <span className="text-11">GitHub Discussions</span>
          </div>
        </CustomMenu.MenuItem>
        <div className="px-1 pt-2 mt-1 text-11 text-secondary border-t border-subtle flex flex-col gap-2">
          <PlaneVersionNumber />
          <OpenSourceBadge />
        </div>
      </CustomMenu>
